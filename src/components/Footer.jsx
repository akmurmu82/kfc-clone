  ...
  return (
    <Box bg={"#1a2224"} color="white" pt={150} pl={100} pr={100} pb={5}>
      <Flex justifyContent="space-around">
        <Box>
          <Image src="https://images.ctfassets.net/wtodlh47qxpt/25FSYFuEtGct8NSrtpKe6d/b602f6fe0bf294e6a6dff5d7648bf594/KFC_Logo.svg"></Image>
        </Box>
        <Box ml={[0, 8]}>
        ...
        <Box>
          <Image src="https://images.ctfassets.net/wtodlh47qxpt/6BdZsyjLn64c06uCIE73d1/fb530f5d5231533b049463f6c7e8a2b1/google_play.svg" />
        </Box>
        <Box>
          <Image src="https://images.ctfassets.net/wtodlh47qxpt/em3mcMuAdXWlgucSJiTbS/d3ae7e51ed101d829e459355e255c47f/apple.svg" />
        </Box>
      </Flex>
      <Flex mt={50} justifyContent={"space-between"}>
        <Text>&copy; 2024 KFC Clone. All rights reserved.</Text>
        <HStack>
          <Image src="https://images.ctfassets.net/wtodlh47qxpt/4ZHyPA2EeaoP3aqtNDriBA/463462a9c27b0aa585e12b21ce3766e0/Social_Insta_White.svg"></Image>
          <Image src="https://images.ctfassets.net/wtodlh47qxpt/dKiu2meLcfz2DNwsg7nZw/7194830b1ba6f25b158a23d6b2c4752c/Social_Facebook_White.svg"></Image>
          <Image src="https://images.ctfassets.net/wtodlh47qxpt/78z9x0WwdkdXwGVK726EKX/6599ca34ec88e2a6f46d7d94ed85a8ad/Social_Twitter_White.svg"></Image>
        </HStack>
      </Flex>
    </Box>
  );
